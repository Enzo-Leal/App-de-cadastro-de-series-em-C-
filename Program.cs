...
namespace cadastro_series
{
    class Program
    {
        ...
        private static void VisualizarSerie()
		{
			...
			var serie = repositorio.RetornaaPorId(indiceSerie);
        ...
        private static void ListarSeries()
        {
            ...
            if (lista.Count == 0)
            {
                Console.WriteLine("Nenhuma série cadastrada em nosso catalogo.");
                return;
            }
        ...
        {
            Console.WriteLine();
            Console.WriteLine("Enzodia Séries a seu dispor!!!");
